...
-- ========================================
-- 初始化甘特排程数据 gantt_schedules（资源占用看板周度矩阵数据源）
-- 覆盖 2026-07-20 ~ 2026-10-04，含已完成/进行中/待排/排定中四类状态
-- ========================================
INSERT IGNORE INTO `gantt_schedules`
(`schedule_code`, `task_name`, `task_type`, `project_code`, `vehicle_model`, `priority`, `status`,
 `assembly_site`, `lift_count`, `equipment_code`, `planner`, `plan_start_time`, `plan_end_time`,
 `actual_start_time`, `actual_end_time`, `progress`, `created_by`) VALUES
-- SZA 装配一期（试制岛产线）
('SCH-2026-0001', 'S3JET0 试制局(淋雨)', 'B', 'S3JET0', '轿车', 'high', 'in_progress',
 'SZA', 2, 'SZA-01,SZA-04', '范骁', '2026-08-03 08:00:00', '2026-08-23 18:00:00',
 '2026-08-03 08:00:00', NULL, 30.00, 'system'),
-- SZC 仓库装配区
('SCH-2026-0002', 'DH3 矮车棚', 'C', 'DH3', 'SUV', 'medium', 'in_progress',
 'SZC', 2, 'SZC-02,SZC-03', '王鹏', '2026-07-27 08:00:00', '2026-08-16 18:00:00',
 '2026-07-27 08:00:00', NULL, 80.00, 'system'),
-- SZB 装配二期（多项目并行）
('SCH-2026-0003', 'S599841 总装装车零件', 'B', 'S599841', 'SUV', 'medium', 'in_progress',
 'SZB', 4, 'SZB-01,SZB-02', '邢浩然', '2026-08-10 08:00:00', '2026-08-30 18:00:00',
 '2026-08-10 08:00:00', NULL, 30.00, 'system'),
('SCH-2026-0004', '乐风翼子车', 'C', '乐风翼子车', '轿车', 'low', 'completed',
 'SZB', 2, 'SZB-03,SZB-04', '邢浩然', '2026-08-03 08:00:00', '2026-08-23 18:00:00',
 '2026-08-03 08:00:00', '2026-08-13 18:00:00', 100.00, 'system'),
-- JP1 竞品一区（多项目并行）
('SCH-2026-0005', 'DHTMPV MPV样车', 'A', 'DHTMPV', 'MPV', 'high', 'completed',
 'JP1', 4, 'JP1-01,JP1-02', '李思贤', '2026-08-03 08:00:00', '2026-08-16 18:00:00',
 '2026-08-03 08:00:00', '2026-08-12 18:00:00', 100.00, 'system'),
('SCH-2026-0006', '7J38E10 整车试装', 'C', '7J38E10', '轿车', 'medium', 'in_progress',
 'JP1', 2, 'JP1-03', '李思贤', '2026-08-10 08:00:00', '2026-08-30 18:00:00',
 '2026-08-10 08:00:00', NULL, 5.00, 'system'),
-- JP2 竞品二区（多项目并行）
('SCH-2026-0007', 'N1F1 长征汽车', 'B', 'N1F1', '轿车', 'medium', 'pending',
 'JP2', 3, 'JP2-01,JP2-02', '李思贤', '2026-08-24 08:00:00', '2026-09-06 18:00:00',
 NULL, NULL, 0.00, 'system'),
('SCH-2026-0008', 'N356 越野车', 'A', 'N356', 'SUV', 'high', 'pending',
 'JP2', 6, 'JP2-03,JP2-04', '李思贤', '2026-09-07 08:00:00', '2026-09-20 18:00:00',
 NULL, NULL, 0.00, 'system'),
-- LH 联合装配区
('SCH-2026-0009', 'M18MPV MPV样车', 'B', 'M18MPV', 'MPV', 'medium', 'in_progress',
 'LH', 5, 'LH-02,LH-05', '金执', '2026-08-03 08:00:00', '2026-08-16 18:00:00',
 '2026-08-03 08:00:00', NULL, 70.00, 'system'),
-- CX1 外委畅行（多项目并行）
('SCH-2026-0010', 'M18-300HEV', 'B', 'M18-300HEV', 'MPV', 'medium', 'in_progress',
 'CX1', 3, 'CX1-02', '外委', '2026-08-10 08:00:00', '2026-08-23 18:00:00',
 '2026-08-10 08:00:00', NULL, 50.00, 'system'),
('SCH-2026-0011', 'BD-515', 'C', 'BD-515', '轿车', 'low', 'pending',
 'CX1', 3, 'CX1-03', '外委', '2026-08-31 08:00:00', '2026-09-13 18:00:00',
 NULL, NULL, 0.00, 'system'),
-- CX2 外委交石（多项目并行）
('SCH-2026-0012', 'M18-200HEV', 'B', 'M18-200HEV', 'MPV', 'medium', 'pending',
 'CX2', 7, 'CX2-01,CX2-02', '外委', '2026-09-14 08:00:00', '2026-09-27 18:00:00',
 NULL, NULL, 0.00, 'system'),
('SCH-2026-0013', 'E70-702', 'C', 'E70-702', '轿车', 'low', 'pending',
 'CX2', 1, 'CX2-03', '外委', '2026-09-21 08:00:00', '2026-10-04 18:00:00',
 NULL, NULL, 0.00, 'system');
